...
export const MemoizedCyberStatsSection = memo<CyberStatsSectionProps>(({ stats, loading, formatCurrency }) => {
...
MemoizedCyberStatsSection.displayName = 'MemoizedCyberStatsSection';
