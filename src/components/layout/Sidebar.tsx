...
const NavItem = ({ icon, label, to, isActive = false, onClick }: NavItemProps) => (
  <li>
    {onClick ? (
      <Button 
        variant="ghost"
        className={cn(
          "flex w-full items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer transition-all justify-start font-normal",
          isActive 
